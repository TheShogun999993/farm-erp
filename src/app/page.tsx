      ...
      <div className="mx-auto max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-8 rounded-xl bg-white p-6 shadow-lg sm:p-8">
          ...
          <section className="rounded-lg border border-gray-200 bg-slate-50/50 p-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                <FormField label="Fisheries Officer Consultation" name="consultation">
                    <select id="consultation" name="consultation" value={formData.consultation} onChange={handleChange} className={inputStyles}>
                        <option>Yes</option>
                        <option>No</option>
              ...
              <FormField label="No. of Fish Added / Restocked" name="restocked"><input type="number" name="restocked" id="restocked" value={formData.restocked} onChange={handleChange} className={inputStyles} /></FormField>
              <FormField label="Average Feed Consumption (kg/day)" name="feed"><input type="text" name="feed" id="feed" value={formData.feed} onChange={handleChange} className={inputStyles} /></FormField>
              <FormField label="Average Water Exchange (litres/day or %)" name="water_exchange"><input type="text" name="water_exchange" id="water_exchange" value={formData.water_exchange} onChange={handleChange} className={inputStyles} /></FormField>
